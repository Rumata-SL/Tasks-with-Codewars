...
/* 
      У Бена есть очень простая идея для получения прибыли:
      он что-то покупает и снова продает. Конечно, это не принесло бы ему никакой прибыли, если бы он просто 
      покупал и продавал по одной и той же цене. Вместо 
      этого он купит
      его по самой низкой цене и продаст по самой высокой.
      Задача
